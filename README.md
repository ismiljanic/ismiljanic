...
[![Spring Boot](https://img.shields.io/badge/-Spring%20Boot-000?&logo=Spring)](https://spring.io/projects/spring-boot)
...
> **SyntaxBase**  
> Full-stack learning platform designed as SaaS with interactive tutorials, structured courses and collaborative forum features.  
> `Java` · `Spring Boot` · `React` · `PostgreSQL` · `Docker` · `Grafana` · `Prometheus`
...
> `Python` · `FastAPI` · `Docker` · `XGBoost` · `BERT` · `Local LLM`
...
> Ticketing system with robust authentication and authorization including Auth0 and NodeJS implementation.  
